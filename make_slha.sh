...
main()
{
  ...
  do
    ...
    echo "test/SusyHiggs_template3.slha 0 ${m} ${n} ${k} ${j} 5000 5000 store_${l}/slha/${TAG}_${NAMEONE}${k}.slha"
    runSLHA test/SusyHiggs_template3.slha 0 ${m} ${n} ${k} ${j} 5000 5000 store_${l}/slha/${TAG}_${NAMEONE}${k}.slha
