...
# 1. Update the MAINDIR shell variable in ElectroweakHiggsinoNLSP.cfg with your current working path

# 2. To generate slha file
./make_slha.sh ElectroweakHiggsinoNLSP.cfg

# 3. To generate lhe file
./make_lhe.sh ElectroweakHiggsinoNLSP.cfg

# 4. To generate MINIAODSIM files
./make_miniaodsim.sh ElectroweakHiggsinoNLSP.cfg
...
# Special notes
# A. The HZ and ZZ modes of the Electroweak Higgsino NLSP scenario
# have undecayed Z bosons in every event therefore it is recommended 
# that Pythia be used to decay it in the desired way
